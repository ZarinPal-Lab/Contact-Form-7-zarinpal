...
/*
Plugin Name: Contact Form 7 - Gateway ZarinPal v1.1
Plugin URI: https://t.me/Developer_89
Description: اتصال فرم های Contact Form 7 به درگاه پرداخت ZarinPal
Author: Javad Zobeidi
Author URI: https://t.me/Developer_89
Version: 1.1
*/



function ZP_CF7_relative_time($ptime)
{
...
function ZP_Contant_Form_7_Gateway_install()
{
...
//register_activation_hook($dir . 'gateway_func.php', 'ZP_Contant_Form_7_Gateway_install');
       ...
       // $transactions = $wpdb->get_results("SELECT * FROM $table_name where (status NOT like 'none') ORDER BY $table_name.id DESC LIMIT $offset, $limit", ARRAY_A);
        ...
        if (count($transactions) == 0) {
            ...
            foreach ($transactions as $transaction) {
                ...
                echo '<br />(';
                echo ZP_CF7_relative_time($transaction["created_at"]);
                echo ' قبل)</td>';
...
<br/><br/><br/>
    ...
    <q1 style="color:#F00;">
    طراح و برنامه نویسی : جواد زبیدی زاده 
    <br>
    پشتیبانی : j.zobeidi89@gmail.com    
    <br>
	تلگرام فقط جهت پشتیبانی : https://t.me/Developer_89
	<br/>
